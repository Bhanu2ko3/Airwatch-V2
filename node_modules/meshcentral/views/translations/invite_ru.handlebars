...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <p>
                Это портал для удаленного управления и поддержки компьютеров.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Неверный код приглашения."];
            if (messageid > 0) {
                var msg = '';
