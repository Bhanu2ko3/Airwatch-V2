...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Benvingut</h1>
            <p>
                Aquest és un portal per a la gestió remota i el suport informàtic.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Codi d'invitació no vàlid."];
            if (messageid > 0) {
                var msg = '';
