...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Bem vindo</h1>
            <p>
                Este é um portal para gerenciamento e suporte remotos de computadores.
            </p>
            <table style="text-align:center;margin-top:60px;width:100%">
                <tbody><tr>
                    ...
                    <td style="font-size:20px;background-color:#DDD;padding:12px;border-radius:16px">
                        <div style="margin-bottom:10px">Código de Convite</div>
                        <form method="post">
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Código de convite inválido."];
            if (messageid > 0) {
                var msg = '';
