...
<body>
        ...
        <tr style="height:20px">
            <td>
                <div>
                    ...
                    <div id="flink" style="float:right;margin-right:4px">{{{rootCertLink}}}&nbsp;<a href="../../terms">Termos e Privacidade</a></div>
                </div>
            </td>
        </tr>
    </tbody></table>
    <script>
        ...
        switch (msgid) {
            ...
            case 13: { msg = "Se você é um administrador, [faça o login aqui].".replace('[', '<a href=?loginscreen=1>').replace(']', '</a>'); break; }
