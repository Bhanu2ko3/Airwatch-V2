...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Hoşgeldiniz</h1>
            <p>
                Bu, bilgisayarın uzaktan yönetimi ve desteği için bir portaldır.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Geçersiz davetiye kodu."];
            if (messageid > 0) {
                var msg = '';
