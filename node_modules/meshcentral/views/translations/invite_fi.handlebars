...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Tervetuloa</h1>
            <p>
                Tämä on portaali tietokoneen etähallintaan ja tukeen.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Virheellinen kutsukoodi"];
            if (messageid > 0) {
                var msg = '';
