...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Willkommen</h1>
            <p>
                Dies ist ein Portal für die Remoteverwaltung und den Support von Computern.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Ungültiger Einladungscode."];
            if (messageid > 0) {
                var msg = '';
