...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Välkommen</h1>
            <p>
                Detta är en portal för datorns fjärrhantering och support.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Ogiltig inbjudningskod."];
            if (messageid > 0) {
                var msg = '';
