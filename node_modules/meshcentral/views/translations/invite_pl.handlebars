...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Witaj</h1>
            <p>
                Jest to portal do zdalnego zarządzania i pomocy technicznej dla komputerów.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Nieprawidłowy kod zaproszenia."];
            if (messageid > 0) {
                var msg = '';
