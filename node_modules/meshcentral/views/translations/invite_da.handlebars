...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Velkommen</h1>
            <p>
                Dette er en portal til computer fjernstyring og support.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Ugyldig invitationskode."];
            if (messageid > 0) {
                var msg = '';
