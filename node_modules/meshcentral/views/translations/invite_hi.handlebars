...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>स्वागत हे</h1>
            <p>
                यह कंप्यूटर दूरस्थ प्रबंधन और समर्थन के लिए एक पोर्टल है।
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["अमान्य आमंत्रण कोड।"];
            if (messageid > 0) {
                var msg = '';
