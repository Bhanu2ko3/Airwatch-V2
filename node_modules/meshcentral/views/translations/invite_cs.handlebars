...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Vítejte</h1>
            <p>
                Toto je portál pro vzdálenou správu a podporu počítače.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Neplatný kód pozvánky."];
            if (messageid > 0) {
                var msg = '';
