...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1>Üdvözöljük</h1>
            <p>
                Ez egy felület a számítógépek távoli kezeléséhez és támogatásához.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Érvénytelen meghívókód."];
            if (messageid > 0) {
                var msg = '';
