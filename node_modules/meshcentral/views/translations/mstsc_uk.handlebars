        ...
        <div class="middleContainer">
            ...
            <table class="signinform">
                ...
                <tr id="dropdowndomain" style="display:none">
                    <td colspan="2">
                        <select id="d3coreMode" style="width:100%;margin-bottom:5px" class="formDropdown" onchange="dropDownChange()"><option value="1">Використовуйте акредитивний сервер</option><option value="2">Використовувати нові облікові дані</option></select>
                    </td>
                </tr>
                <tr id="rowdomain" style="display:none">
                    <td><label for="inputDomain" class="formLabel">Домен</label></td>
                    <td style="text-align:right"><input type="text" id="inputDomain" class="formControl" placeholder="Домен"></td>
                </tr>
                <tr id="rowusername" style="display:none">
                    <td><label for="inputUsername" class="formLabel">Ім'я користувача</label></td>
                    <td style="text-align:right"><input type="text" id="inputUsername" class="formControl" placeholder="Ім'я користувача"></td>
                </tr>
                <tr id="rowpassword" style="display:none">
                    <td><label for="inputPassword" class="formLabel">Пароль</label></td>
                    <td style="text-align:right"><input type="password" id="inputPassword" class="formControl" placeholder="Пароль"></td>
                </tr>
                <tr id="rowremember" style="display:none">
                    <td></td>
                    <td><label><input type="checkbox" id="inputSaveCredentials" style="margin-left:8px;margin-right:5px">Запам'ятати облікові дані</label></td>
                </tr>
                <tr>
                    <td colspan="2"><button class="connectButton" onclick="return connect()">Підключитись</button></td>
                </tr>
            </tbody></table>
        </div>
    </div>
