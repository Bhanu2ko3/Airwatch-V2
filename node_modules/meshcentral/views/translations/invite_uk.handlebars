...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <p>
                Це портал віддаленого керування комп'ютером і підтримки.
            </p>
    ...
    <script>
        ...
        function start() {
            ...
            var okmessages = [''];
            var failmessages = ["Хибний код запрошення."];
            if (messageid > 0) {
                var msg = '';
