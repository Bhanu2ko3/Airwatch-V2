                                ...
                                <tr>
                                    <td>
                                        <input id="password" title="Password"
                                            style="box-sizing:border-box;width:280px;border:0;border-radius:10px;padding:10px;"
                                        ...
                                        <button type="button" onclick="togglePassword()"
                                            style="position:absolute;right:40px;top:48%;transform:translateY(-50%);background:none;border:none;cursor:pointer;">
                                            👁️
                                        </button>
                                    </td>
                                </tr>
